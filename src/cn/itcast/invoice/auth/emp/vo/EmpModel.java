...
<%@ page import="cn.itcast.invoice.auth.emp.vo.EmpModel" %>
  			...
  			<div style="border:1px solid #cecece;">
				...
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
				    ...
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td>
				      	<input type="text" value="${em.getBirthdayView()}" size="25" onfocus="c.showMoreDay=false;c.show(this);" readonly="true"/>
